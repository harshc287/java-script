...
// //for in                     for off
// array= [1,13,41,51,31,21,]               //gives indesx no as output
// for(x in array){
//     console.log(x)
// }

// for(y of array){
//     console.log(y)              //gives values of indexes
// }


// //map
// array.map((element, index)=>console.log(element, index))        //without return 
...
// //square
// array.map((square,i)=>console.log("square of",square, square*square))

let items = ["Pen", "Book", "Eraser"];
indexbook= items.indexOf('Book')
console.log(indexbook);

indexElmt = items.indexOf('jahagaf')
console.log(indexElmt)

let colors = ["Red", "Blue", "Green", "Yellow"];
subcolor= colors.slice(1,4)
...
numArr=[21, 22, 43, 54, 75, 86, 97, 0, 86, 49]
evenArr = numArr.filter((num)=>num % 2 == 0)
console.log(evenArr)

oddNumbers = numArr.filter((num)=>{
    return num % 2!= 0
})
...
str1 = items.every((item)=> typeof(item) == 'string')
console.log(str1);
